...
import RegPoli from "components/machine-learning/RegPoli";


export default function RegresionPoli() {
  return (
    <FullWidthLayout>
        ...
        <div class="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
          ...
          <div class="max-w-xl mb-6">
            ...
            <p class="text-white text-base md:text-lg">
                Como se puede ver en la tabla, el salario de los empleados dependiendo el puesto no crece de manera lineal si no como exponencial,
                por lo que necesitaríamos crear un modelo de Regresión Lineal Polinómica para estimar el sueldo de los potenciales empleados. En este caso
                un modelo con un polinomio de grado 3
            <p class="text-white text-base md:text-lg">

                Una vez creado el modelo solo falta con saber el puesto en el que va a trabajar y hacer la predicción
            </p>
