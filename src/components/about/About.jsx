...
import { SiReact, SiDjango, SiPostgresql, SiPython, SiTailwindcss, SiStripe } from "react-icons/si";
...
const people = [
    {
      ...
      bio: 'Me llamo Gaston Franco, Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed purus tortor, laoreet a urna sed, posuere dapibus erat. Aenean sodales hendrerit eros, ut iaculis purus aliquam et. Nam faucibus tellus sem, sed pellentesque est venenatis nec. Curabitur dignissim consequat mi, sit amet placerat arcu bibendum quis. Nulla et erat malesuada, efficitur tellus accumsan, pretium lorem. Donec eleifend porta nibh, non suscipit metus cursus eget',
      twitterUrl: '#',
      linkedinUrl: '#',
      youtubeUrl: '#',
    },
        ...
        <FullWidthLayout>
            <div className="mx-auto pt-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:pt-24">
                ...
                <div className="space-y-5 sm:space-y-4">
                    <h2 className="text-3xl font-gilroy-black tracking-tight sm:text-4xl dark:text-white">Sobre Mí</h2>
                    <p className="text-xl text-gray-500">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed purus tortor, laoreet a urna sed, posuere dapibus erat. Aenean sodales hendrerit eros, ut iaculis purus aliquam et. Nam faucibus tellus sem, sed pellentesque est venenatis nec. Curabitur dignissim consequat mi, sit amet placerat arcu bibendum quis. Nulla et erat malesuada, efficitur tellus accumsan, pretium lorem. Donec eleifend porta nibh, non suscipit metus cursus eget                    </p>
                </div>
            ...
            <section aria-labelledby="features-heading" className="max-w-7xl mx-auto py-16 sm:px-2 lg:px-8">
                ...
                <div className="max-w-3xl">
                    <h2 id="features-heading" className="text-3xl font-gilroy-black tracking-tight text-gray-900 sm:text-4xl dark:text-zinc-300">
                    Portafolio
                    </h2>
            ...
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                ...
                <div className="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
                    <a href="#" className="flex justify-center items-center text-8xl text-gray-400">
                <SiPython/>                                                                                  
                </a>
                    </div>
                    <div className="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
